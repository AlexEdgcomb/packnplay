...
func (r *Runner) GetServiceContainerID() (string, error) {
	...
	// Docker compose may output warnings to stderr (e.g., about obsolete version attribute)
	// which would corrupt the container ID if captured together
	output, err := cmd.Output()
	if err != nil {
		// If there was an error, try to get stderr for better error messages
